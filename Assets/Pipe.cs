...
public class Pipe : MonoBehaviour
{
    ...
    public string type = "PIPE_TYPE";
    public string street = "STREET_NAME";
    ...
    public string GetDescription()
    {
        ...
        descr = type switch
        {
            "COL" => "Collection sewer",
            "PRM" => "Primary sewer(trunk)",
            "DRY" => "Dry sewer",
            "ABN" => "Abandoned",
            _ => type,
        };
        descr = string.Concat( descr , string.IsNullOrWhiteSpace(street)? "" : "\n" + street + " street");
        return descr;
    }
